...
class Obstacle:
    ...
    def get_robot_target_pos(self):
        ...
        if self.pos.direction.value == 90: #TOP
            return RobotPosition(self.pos.x, self.pos.y + OBSTACLE_SAFETY_WIDTH, Direction.BOTTOM)
        elif self.pos.direction.value == -90: #BOTTOM
            return RobotPosition(self.pos.x, self.pos.y - OBSTACLE_SAFETY_WIDTH, Direction.TOP)
        elif self.pos.direction.value == 180: #LEFT
            return RobotPosition(self.pos.x - OBSTACLE_SAFETY_WIDTH, self.pos.y, Direction.RIGHT)
        else: #RIGHT
            return RobotPosition(self.pos.x + OBSTACLE_SAFETY_WIDTH, self.pos.y, Direction.LEFT)
