        ...
        for i in path:
            if i != 0:
                ...
                for j in range(len(Goals)):
                    if Goals[j][0] == t[0] and Goals[j][1] == t[1]:
                        break
                ...
                for Goals in range(len(move)):
                    if move[Goals] in self.simulator.robot_temp_movement:
                        if self.bearing == direction[Goals]:
                            ...
                            self.simulator.robot_temp_movement.remove(tempStart)
                            break
                        elif self.bearing == direction[(Goals + 3) % 4]:
